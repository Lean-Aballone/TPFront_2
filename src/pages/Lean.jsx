                ...
                <div className="lean-container">
                    ...
                    <section>
                        ...
                        <About className="sectionAbout musicaContainer" title={"Música favorita:"} msg={" Podés escuchar haciendo click sobre el nombre de la banda "}>
                            <Musica className="dark-bg" id={"linkin-park"} name={"Linkin park"}/>
                            <Musica className="dark-bg" id={"ghost-bc"} name={"Ghost B.C."}/>
                            <Musica className="dark-bg" id={"coldplay"} name={"Coldplay"}/>
                        </About> 
